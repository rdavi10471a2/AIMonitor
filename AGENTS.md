...
- CLI/Codex command names and MCP/Claude tool names are different adapter surfaces over the same shared workflow. Do not mix host-specific command names when writing operator instructions or restart notes.
